...
def main():
    ...
    with open('resultss.csv', 'r',newline='') as inputfile:
        with open('no_dups_results.csv', 'w', newline='') as outputfile:
...
csv_data = pd.read_csv('no_dups_results.csv', index_col=False, header=0)
...
def classify_emails():
    for row in csv_data.itertuples():
        ...
        get_website_lower = get_website.lower()
...
def classified_csv():
    ...
    df2.to_csv('classified_urls_results.csv')
    return df2
